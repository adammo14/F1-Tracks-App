...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/scripts/CustomMap.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  CustomMap.prototype.addMarker = function (pin) {
    var _this = this;
...
var customMap = new CustomMap_1.CustomMap('map'); // Gets circuits
...
var populateStandings = function populateStandings(result) {
  removeElements('driver');
  var table = document.getElementById("standingsTable"); // helper function        
...
var removeElements = function removeElements(className) {
...
},{"axios":"node_modules/axios/index.js","./CustomMap":"src/scripts/CustomMap.ts"}],"../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
